    ...
    <div className="px-4 py-6 space-y-8 ">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="space-x-2">
          {priority && <span className="rounded-full py-1 px-3 bg-red-500 font-semibold text-red-50 tracking-wide uppercase">Priority</span>}
          <span className="rounded-full py-1 px-3 bg-green-500 font-semibold text-green-50 tracking-wide uppercase">{status} order</span>
        </div>
      </div>
